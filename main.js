...
var search=nav_search.querySelector('.search-bar');
var search_hint=nav_search.querySelector('.search-hints');
var search_btn=document.querySelector('.search-bt');
var search_input=search.querySelector('input');
var prev_button = document.getElementsByName('page-prev'); 
var next_button = getElementByXpath("/html/body/div[5]/button[2]") 
...
if(document.getElementsByName("page-number").value==2){
    console.log("prev clicked")
    document.getElementsByName("page-number").value = 1
...
next_button.onclick() = function() {
    ...
    if(document.getElementsByName("page-number").value==1){
        console.log("next clicked")
        document.getElementsByName("page-number").value = 2
